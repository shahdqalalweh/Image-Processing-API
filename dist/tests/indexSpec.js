...
describe('Testing endpoints', () => {
    describe('Test invalid requests', () => {
        ...
        it('images endpoint with no width and height is missing width or height bad request', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request.get('/api/images?filename=nature.jpg');
            expect(response.badRequest).toBe(true);
        ...
        it('images endpoint with text height is invalid width or height bad request', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request.get('/api/images?filename=p.jpg&width=500&height=500fivehundred');
            expect(response.badRequest).toBe(true);
            expect(response.text).toEqual('Error: invalid width or height parameters');
        }));
        it('images endpoint with non existant image is not found request', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request.get('/api/images?filename=notreal.jpg&width=500&height=500');
    ...
    describe('Test valid requests', () => {
        it('create a resized image', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield request.get('/api/images?filename=nature.jpg&width=500&height=500');
            expect(response.ok).toBe(true);
            yield promises_1.default.unlink('./assets/thumb/500w_500h_nature.jpg');
        }));
        it('create 3 resized images', () => __awaiter(void 0, void 0, void 0, function* () {
            const response1 = yield request.get('/api/images?filename=p.jpg&width=800&height=300');
            yield promises_1.default.unlink('./assets/thumb/800w_300h_p.jpg');
            const response2 = yield request.get('/api/images?filename=nature.jpg&width=400&height=100');
            yield promises_1.default.unlink('./assets/thumb/400w_100h_nature.jpg');
            const response3 = yield request.get('/api/images?filename=p.jpg&width=200&height=600');
            yield promises_1.default.unlink('./assets/thumb/200w_600h_p.jpg');
